...
!(function (a) {
    ...
    R('TargetOrigin for parent set to: ' + T),
      ...
      (Q.parentIFrame = {
        autoResize: function (e) {
          return (
            !0 === e && !1 === r ? ((r = !0), pe()) : !1 === e && !0 === r && ((r = !1), fe('remove'), null !== s && s.disconnect(), clearInterval(B)), F(0, 0, 'autoResize', JSON.stringify(r)), r
          );
        },
        close: function () {
          F(0, 0, 'close');
      ...
      (h = (function () {
        function n(e) {
          var e = e.getBoundingClientRect(),
            t = { x: window.pageXOffset === a ? document.documentElement.scrollLeft : window.pageXOffset, y: window.pageYOffset === a ? document.documentElement.scrollTop : window.pageYOffset };
  ...
  function fe(e) {
    t({ method: e, eventType: 'Animation Start', eventNames: ['animationstart', 'webkitAnimationStart'] }),
      ...
      t({ method: e, eventType: 'Transition Iteration', eventNames: ['transitioniteration', 'webkitTransitionIteration', 'MSTransitionIteration', 'oTransitionIteration', 'otransitioniteration'] }),
  ...
  function F(e, t, n, o, i) {
    !0 === V &&
      (a === i ? (i = T) : R('Message targetOrigin: ' + i), R('Sending message to host page (' + (e = w + ':' + (e + ':' + t) + ':' + n + (a === o ? '' : ':' + o)) + ')'), X.postMessage(y + e, i));
  }
  function Ne() {
